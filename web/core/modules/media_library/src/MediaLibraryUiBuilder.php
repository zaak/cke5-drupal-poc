...
//    error_log('$plugin_definition[\'forms\'][\'media_library_add\'] vvvvv');
//    error_log($plugin_definition['forms']['media_library_add']);
//    error_log(json_encode($state->getOpenerParameters()));
//    error_log('???????');
    $f = $this->formBuilder->buildForm($plugin_definition['forms']['media_library_add'], $form_state);
//    error_log('-------------');
